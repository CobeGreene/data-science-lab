...
import { PluginInputViewModel, AlgorithmTrackerViewModel } from '../../../../../shared/view-models';

@Component({
    selector: 'app-experiment-algorithm-inputs',
    templateUrl: './experiment-algorithm-inputs.component.html',
    styleUrls: []
})
export class ExperimentAlgorithmInputsComponent implements OnInit, OnDestroy {
    ...
    @Input() tracker: AlgorithmTrackerViewModel;
